...
the factor loadings to the original data matrix, {\it i.e.\,}  $S = X.B$. The
matrix $S\tr.S = D $ is diagonal with elements equal to the first $C$ 
...
conventional principle components. 
